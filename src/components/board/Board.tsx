...
const Board: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen  text-white p-4 m-2">
      <div className='p-1'>
        ...
        <div className="w-full max-w-md md:max-w-lg lg:max-w-xl bg-gray-700 p-6 rounded-xl shadow-lg mt-10">
          {/* Game Board */}
